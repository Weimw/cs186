...
public class Database implements AutoCloseable {
    ...
    private class TransactionContextImpl extends AbstractTransactionContext {
        ...
        @Override
        public void close() {
            // TODO(hw4_part2_task2): release locks held by the transaction
            List<Lock> locks = lockManager.getLocks(this);
            Collections.reverse(locks);
            for (Lock lock: locks) {
                LockContext context = LockContext.fromResourceName(lockManager, lock.name);
    ...
    private class TransactionImpl extends AbstractTransaction {
        ...
        public void dropAllTables() {
            ...
            try {
                // TODO(hw4_part2): add locking
                LockContext context = getTableInfoContext().parentContext();
